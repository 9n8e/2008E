char __cdecl RBX::Http::isRobloxSite(char *url)
{
  int v1; // eax
  ...
  ATL::CStringT<char,ATL::StrTraitATL<char,ATL::ChTraitsCRT<char> > > result; // [esp+8h] [ebp-1254h] BYREF
  ...
  v3 = ATL::CStringT<char,ATL::StrTraitATL<char,ATL::ChTraitsCRT<char>>>::Right(&v8, &result, 10);
